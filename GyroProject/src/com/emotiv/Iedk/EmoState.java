...
public interface EmoState extends Library {
	...
	public enum IEE_FacialExpressionAlgo_t {
		...
		FE_NEUTRAL(0x0001), //1
		FE_BLINK(0x0002), //2
		FE_WINK_LEFT(0x0004), //4
		FE_WINK_RIGHT(0x0008),//8 
		FE_HORIEYE(0x0010), //16
		FE_SURPRISE(0x0020), //32
		FE_FROWN(0x0040), //64 Froncer les sourcils
		FE_SMILE(0x0080), //128
		FE_CLENCH(0x0100), //256

		FE_LAUGH(0x0200), //512
		FE_SMIRK_LEFT(0x0400), //1024
		FE_SMIRK_RIGHT(0x0800); //2048
